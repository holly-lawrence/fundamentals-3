let TaxCalculator = class TaxCalculator {
  ...
  calculateInitialPayment(fuelType, co2Emissions) {
    const co2_bounds = [0,1,51,76,91,101,111,131,151,171,191,226,256, Infinity];
  ...
  calculateTax(vehicle) {
    ...
    // Find Price
    const initial_price = this.calculateInitialPayment(vehicle.fuelType, vehicle.co2Emissions);
